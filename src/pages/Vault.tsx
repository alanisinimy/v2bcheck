...
import { useAssets, useUploadAsset, useUpdateAssetStatus } from '@/hooks/useProject';
...
export default function Vault() {
  const { data: dbAssets } = useAssets(DEMO_PROJECT_ID);
  ...
  const assets = dbAssets?.length ? dbAssets : [...MOCK_ASSETS, ...localAssets];
