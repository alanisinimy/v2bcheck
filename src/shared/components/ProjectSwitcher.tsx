    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl bg-accent/50 hover:bg-accent transition-colors active-scale text-left">
        ...
        <DropdownMenuContent align="start" className="w-64 bg-popover/95 backdrop-blur-xl border-border/50" sideOffset={8}>
          {projects.map((project) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-foreground truncate">{project.client_name}</p>
