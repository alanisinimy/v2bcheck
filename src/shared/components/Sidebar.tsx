...
const navItems = [
  ...
  { label: 'The Vault', icon: Upload, path: '/vault' },
  { label: 'Matriz de Diagnóstico', icon: Grid3X3, path: '/matriz' },
  { label: 'Time', icon: Users, path: '/team' },
  { label: 'Plano Estratégico', icon: Lightbulb, path: '/plan' },
];
