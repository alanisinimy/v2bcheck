...
// localStorage key for last selected project only
...
export function ProjectProvider({ children }: { children: ReactNode }) {
  ...
  // Restore last selected project when projects load
  useEffect(() => {
  ...
  // Set current project and persist ID to localStorage
  const setCurrentProject = useCallback((project: Project) => {
    setCurrentProjectState(project);
    localStorage.setItem(LAST_PROJECT_KEY, project.id);
  }, []);

  // Add new project via Supabase
