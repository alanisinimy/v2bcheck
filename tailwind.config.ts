  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        pilar: {
          pessoas: "oklch(var(--pilar-pessoas))",
          processos: "oklch(var(--pilar-processos))",
          dados: "oklch(var(--pilar-dados))",
          tecnologia: "oklch(var(--pilar-tecnologia))",
          gestao: "oklch(var(--pilar-gestao))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
